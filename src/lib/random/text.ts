...
// 随机生成一段文本。
export const paragraph = function (min, max) {
...
export const cparagraph = function (min, max) {
  const len = _range(3, 7, min, max)
  const result: string[] = []
  for (let i = 0; i < len; i++) {
...
export const sentence = function (min?, max?) {
...
// 随机生成一个中文句子。
export const csentence = function (min?, max?) {
  const len = _range(12, 18, min, max)
  const result: string[] = []
  for (let i = 0; i < len; i++) {
    result.push(cword())
...
// 随机生成一个单词。
export const word = function (min?, max?) {
...
// 随机生成一个或多个汉字。
export const cword = function (pool?, min?, max?) {
...
export const title = function (min, max) {
  const len = _range(3, 7, min, max)
  let result: string[] = []
  for (let i = 0; i < len; i++) {
...
// 随机生成一句中文标题。
export const ctitle = function (min, max) {
  const len = _range(3, 7, min, max)
  let result: string[] = []
  for (let i = 0; i < len; i++) {
    result.push(cword())
