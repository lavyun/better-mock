...
var img = image; // 生成一段随机的 Base64 图片编码。
...
var tree = function tree(list) {
  ...
  for (var ii = 0; ii < list.length; ii++) {
    ...
    var parent_1 = mapped[item.pid] || mapped[item.parentId];
...
var dict$1 = tree(fixed);

var REGION = ['东北', '华北', '华东', '华中', '华南', '西南', '西北']; // 随机生成一个大区。
...
var id$1 = function id() {
  ...
  id = pick(dict$1).id + date('yyyyMMdd') + string('number', 3);
