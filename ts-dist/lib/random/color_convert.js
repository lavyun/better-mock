...
export var rgb2hsv = function rgb2hsv(rgb) {
...
export var hsl2rgb = function hsl2rgb(hsl) {
...
export var hsl2hsv = function hsl2hsv(hsl) {
...
export var hsv2rgb = function hsv2rgb(hsv) {
    var h = hsv[0] / 60;
    var s = hsv[1] / 100;
    var v = hsv[2] / 100;
...
export var hsv2hsl = function hsv2hsl(hsv) {
...
export var rgb2hex = function (a, // red, as a number from 0 to 255
b, // green, as a number from 0 to 255
c // blue, as a number from 0 to 255
) {
    return "#" + ((256 + a << 8 | b) << 8 | c).toString(16).slice(1);
};
export var hex2rgb = function (a // take a "#xxxxxx" hex string,
) {
    a = '0x' + a.slice(1).replace(a.length > 4 ? a : /./g, '$&$&');
