...
*/
export var image = function (size, background, foreground, format, text) {
...
export var dataImage = function (size, text) {
    var canvas;
    ...
    var background = _brandColors[helper.pick(Object.keys(_brandColors))];
    var foreground = '#FFF';
    var text_height = 14;
    var font = 'sans-serif';
    canvas.width = width;
