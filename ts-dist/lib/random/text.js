...
// 随机生成一段文本。
export var paragraph = function (min, max) {
...
export var cparagraph = function (min, max) {
    var len = _range(3, 7, min, max);
    var result = [];
    for (var i = 0; i < len; i++) {
...
export var sentence = function (min, max) {
...
// 随机生成一个中文句子。
export var csentence = function (min, max) {
    var len = _range(12, 18, min, max);
    var result = [];
    for (var i = 0; i < len; i++) {
        result.push(cword());
...
// 随机生成一个单词。
export var word = function (min, max) {
...
// 随机生成一个或多个汉字。
export var cword = function (pool, min, max) {
...
export var title = function (min, max) {
    var len = _range(3, 7, min, max);
    var result = [];
    for (var i = 0; i < len; i++) {
...
// 随机生成一句中文标题。
export var ctitle = function (min, max) {
    var len = _range(3, 7, min, max);
    var result = [];
    for (var i = 0; i < len; i++) {
        result.push(cword());
